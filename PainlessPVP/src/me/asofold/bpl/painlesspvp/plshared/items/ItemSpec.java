...
import me.asofold.bpl.painlesspvp.plshared.Items;
...
public class ItemSpec {
	...
	public ItemSpec(final int id, final int data){
		this.id = id;
		this.data = data;
		hash = ((id*4096 + data) * ((data%2==1)?17:31))^id; // TODO: How did this get here !?
	}
	...
	public ItemStack getItem(int amount){
		...
		Material mat = Material.getMaterial(id);
		if ( mat == null ) return null;
		if ( mat.isBlock()) new ItemStack(id, amount, (short) data );
